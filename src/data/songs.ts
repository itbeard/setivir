...
Ды гэта скарб, які не страцім ні пры якіх умовах. `,
  ...
  song(2, 'muzhyk-belarus', 'Мужык-Беларус', 'Mužyk-biełarus', 'png', '2. Setivir - Muzjik-Belarus.mp3', {
    date: '28/08/2025',
    model: 'Suno v4.5+',
    lyricsAuthor: { be: 'Янка Купала', en: 'Yanka Kupala' },
    description: {
      be: `Гэтая песьня створаная на аснове верша Янкі Купалы «Я мужык-беларус…» — знакавага голасу сельскай Беларусі пачатку ХХ стагодзьдзя. «Мужык» азначае селяніна (класавае паняцьце), а «пан» — землеўладальнік; апавядальнік называе сябе «панам сахі і касы», іранічна ўладаром адно толькі прылад. Вобразы голаду як «бацькі» і бяды як «маці», таго, як ён корміць сьвет хлебам, а сам есьць мякіну, і ператварэньня густога лесу ў палі (сцягнуў драўляную саху з вышак, зацягнуў кабылку) падкрэсьліваюць эксплуатацыю і цяжкую працу; «тачок» — гэта дзежка/кораб пшаніцы, які прысабечвае пан. «Цёмен сам, белы вус» намякае на асмаленую сонцам, старэючую беднасьць, а «цёмен» азначае і трыманага ў невуцтве — адсюль «каб чытаць кніжкі ўмеў». Прыпеў сьцьвярджае годнасьць і абуджэньне: нягледзячы на пагарду і маўчаньне, «і я — чалавек», стомлены нядоляй усяго жыцьця.`,
      en: `This song is based on Janka Kupala’s poem “Я мужык-беларус…” (“I am a Belarusian muzhik”), a seminal early-20th-century voice of rural Belarus. Muzhik means peasant (a class term), while pan is the landlord; the speaker calls himself “lord of the plough (sokha) and scythe (kasa),” ironically master only of tools. Images of hunger as “father” and misfortune as “mother,” feeding the world with bread yet eating chaff, and clearing a dense forest into fields (pulling the wooden ard from the rafters, tightening the little mare) underscore exploitation and toil; тачок is a tub/basket of wheat the lord appropriates. “Dark himself, white moustache” evokes sun-darkened, aging poverty, and цёмен also means kept in ignorance—hence “if only I could read books.” The refrain asserts dignity and awakening: despite contempt and silence, “I too am a human being,” weary of lifelong hardship.`,
    },
    lyrics: {
      be: `[Куплет]
Я мужык-беларус,—
