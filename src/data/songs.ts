 ...
 *  На старонцы трэкі ідуць ад першага да апошняга; наведвальнік можа
 *  разьвярнуць парадак кнопкай у шапцы (выбар захоўваецца ў localStorage).
 * ─────────────────────────────────────────────────────────────────────────
 */
...
const ASSETS: Record<string, { ext: string; audio: string; viz?: string }> = {
  ...
  'shto-kashtuje': { ext: 'jpg', audio: "17. Setivir - Što Kaštuje.mp3" },
