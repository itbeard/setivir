...
import styles from './BarsViz.module.css'

/**
 * A radial spectrum of bars (стоўбікі) around the cover — the original default
 * visualizer, kept in the registry as `bars`. Bars sit on a circle just
 * outside the framed art and grow outward with the music — a circular
...
export function BarsViz({ playing }: CoverVizProps) {
